 ...
 * Title:        plp_mat_sub_stride_i32p_xpulpv2.c
 * Description:  parallel 32-bit integer strided matrix subtraction for XPULPV2
 *
 * $Date:        strided matrix subtraction
 * $Revision:    V0
 *
...
/**
  @brief Parallel strided matrix subtraction of 32-bit integer matrices kernel for XPULPV2
  extension.
...
void plp_mat_sub_stride_i32p_xpulpv2(void *args) {
    ...
    plp_mat_sub_stride_instance_i32 *a = (plp_mat_sub_stride_instance_i32 *)args;
