 ...
 * Title:        plp_mat_sub_stride_i8s_rv32im.c
 * Description:  8-bit strided matrix subtraction kernel for RV32IM
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief strided matrix subtraction of 8-bit integer matrices kernel for RV32IM extension.
