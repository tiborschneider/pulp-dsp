 ...
 * Title:        plp_mat_sub_stride_f32s_xpulpv2.c
 * Description:  32-bit floating-point strided matrix subtraction for XPULPV2
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief strided matrix subtraction of 32-bit floating-point matrices kernel for XPULPV2 extension.
