 ...
 * Title:        plp_mat_sub_stride_i8s_xpulpv2.c
 * Description:  8-bit integer strided matrix subtraction for XPULPV2
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @brief strided matrix subtraction of 8-bit integer matrices kernel for XPULPV2 extension.
