 ...
 * Title:        plp_mat_add_stride_i16s_rv32im.c
 * Description:  16-bit strided matrix addition kernel for RV32IM
 *
 * $Date:        1. July 2020
 * $Revision:    V0
 *
...
/**
  @defgroup MatAddStrideKernels Strided Matrix Addition Kernels
  This module contains the kernels for strided matrix addition.
  ...
  `plp_mat_add_stride_i32s_xpulpv2`):
...
/**
  @brief strided matrix addition of 16-bit integer matrices kernel for RV32IM extension.
